...
Group:          Development/Libraries/C and C++
Requires:       libpmemblk1 = %{epoch}:%{version}-%{release}
...
Group:          Development/Libraries/C and C++
Requires:       libpmemlog1 = %{epoch}:%{version}-%{release}
...
Group:          Development/Libraries/C and C++
Requires:       librpmem1 = %{epoch}:%{version}-%{release}
